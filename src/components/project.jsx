...
function Project() {
  return (
    <>
    <div className="mt-9">
    <h1 className="mt-2  font-bold text-sky-400 underline underline-offset-2">Project</h1>
    <small className="text-gray-400 italic ">some things I ve been working on</small>
    </div>
